...
export INPUT_DIRECTORY=$(yaml $CONFIG_FILE "['annual_mean_runoff']['input_directory']")
export INPUT_FILE_SUFFIX=$(yaml $CONFIG_FILE "['annual_mean_runoff']['input_file_suffix']")
export OUTPUT_FILENAME=$(yaml $CONFIG_FILE "['annual_mean_runoff']['output_filename']")
...
python ${SRC_DIR}/annual-mean-runoff.py
conda deactivate 
